...
type NewGroup = { id: number; name: string; members: number; avatar: string; color: string; lastMsg: string; time: string; unread: number };

function CreateGroupModal({ onClose, onCreate }: { onClose: () => void; onCreate: (g: NewGroup) => void }) {
            ...
            <div className="px-4 py-4 space-y-3">
              ...
              >
                {loading
                  ...
                  : <><Icon name="Plus" size={15} />Создать группу</>
                }
              </button>
            </div>
          </>
